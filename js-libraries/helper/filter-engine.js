...
P.actionExternalData = function (packet) {

    const { filters, image } = packet;
    const { actions, theBigActionsObject } = this;
...
// An independent way to get filters applied to image data objects
export const applyFilterToImageData = filterEngine.actionExternalData;
